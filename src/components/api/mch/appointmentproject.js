export function del(query, success, fail, complete, others) {
      ...
      export function update(query, success, fail, complete, others) {
          const app = getApp();
          const config = Object.assign({}, {"url":"///mch/appointment/project/update","headers":{"Content-Type":"application/json"},"method":"POST","dataType":"json"},{ headers: Object.assign({}, {"Content-Type":"application/json"}, { atk: query.atk})})
          delete query.atk
          let _query = query;
          config.headers["content-type"] = config.headers["Content-Type"]
          if(config.headers["content-type"] === "application/json" ) {
              ...
              success: resp => {
                ...
                if (data.code == '0') {
                  ...
                  app.checkAuth('auth_base').then(({ token = '' }) => {
                    // 数据更新
                    app.CONSTANTS.atk = token
                    my.request(Object.assign({}, {"url":"///mch/appointment/project/update","headers":{"Content-Type":"application/json"},"method":"POST","dataType":"json"}, {data: query}, others,
                    {
                      success: responese => {
                        const data_ = responese.data || {}
                        success(data_.data, data_)
      ...
      export function list(query, success, fail, complete, others) {
          const app = getApp();
          const config = Object.assign({}, {"url":"///mch/appointment/project/list","headers":{"atk":""},"method":"GET","dataType":"json"},{ headers: Object.assign({}, {"atk":""}, { atk: query.atk})})
          delete query.atk
          let _query = query;
          config.headers["content-type"] = config.headers["Content-Type"]
          if(config.headers["content-type"] === "application/json" ) {
              ...
              success: resp => {
                ...
                if (data.code == '0') {
                  ...
                  app.checkAuth('auth_base').then(({ token = '' }) => {
                    // 数据更新
                    app.CONSTANTS.atk = token
                    my.request(Object.assign({}, {"url":"///mch/appointment/project/list","headers":{"atk":""},"method":"GET","dataType":"json"}, {data: query}, others,
                    {
                      success: responese => {
                        const data_ = responese.data || {}
                        success(data_.data, data_)
